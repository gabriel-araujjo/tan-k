...
//  public static String DERIVATIVE_PART_CURVE = "Componente derivativa";
  ...
  private void initComponents() {
    ...
    panelPIDControl = new javax.swing.JPanel();
    ...
    openedLoopSettingsLayout.setHorizontalGroup(
      ...
      .addGroup(openedLoopSettingsLayout.createSequentialGroup()
        .addGroup(openedLoopSettingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addGroup(openedLoopSettingsLayout.createSequentialGroup()
            .addContainerGap()
            .addComponent(outputSettings, javax.swing.GroupLayout.PREFERRED_SIZE, 331, Short.MAX_VALUE))
    ...
    javax.swing.GroupLayout panelPIDControlLayout = new javax.swing.GroupLayout(panelPIDControl);
    panelPIDControl.setLayout(panelPIDControlLayout);
    panelPIDControlLayout.setHorizontalGroup(
      panelPIDControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addGroup(panelPIDControlLayout.createSequentialGroup()
        .addContainerGap()
        .addGroup(panelPIDControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addGroup(panelPIDControlLayout.createSequentialGroup()
            .addGroup(panelPIDControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
              .addComponent(taudLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
              .addComponent(controllerTypeLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    panelPIDControlLayout.setVerticalGroup(
      panelPIDControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addGroup(panelPIDControlLayout.createSequentialGroup()
        .addContainerGap(47, Short.MAX_VALUE)
        .addGroup(panelPIDControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    waveParams1Layout.setHorizontalGroup(
      ...
      .addComponent(setPoint, javax.swing.GroupLayout.DEFAULT_SIZE, 355, Short.MAX_VALUE)
      .addGroup(waveParams1Layout.createSequentialGroup()
        .addComponent(panelPIDControl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    sidebarLayout.setHorizontalGroup(
      ...
      .addComponent(writeBox, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    );
    ...
    layout.setVerticalGroup(
      ...
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addComponent(scrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 422, Short.MAX_VALUE))
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void applyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_applyMouseClicked
        ...
        if(servoButton.isSelected()){
          ...
          Complex64F p1 = null, p2 = null, p3 = null, aux;
            boolean refresh = false;

            Pattern complexPattern = Pattern.compile("^\\s*([-+]?(?:\\d+|\\d*\\.\\d+))?(?:\\s*([-+](?:\\d+|\\d*\\.\\d+))[ij])?\\s*$");
            Matcher matcher;

            matcher = complexPattern.matcher(polo1Field1.getText());
            while (matcher.find()) {
                System.out.println("real encontrado = "+matcher.group(1));
                System.out.println("imaginario encontrado ="+matcher.group(2));
                double real = matcher.group(1)!=null?Double.parseDouble(matcher.group(1)):0.0;
                double imag = matcher.group(2)!=null?Double.parseDouble(matcher.group(2)):0.0;
                System.out.println("Re{p1} = "+real);
                System.out.println("Im{p1} = "+imag);
                p1 = new Complex64F(real, imag);
            }
            
            matcher = complexPattern.matcher(polo2Field1.getText());
            while (matcher.find()) {
                System.out.println("real encontrado = "+matcher.group(1));
                System.out.println("imaginario encontrado ="+matcher.group(2));
                double real = matcher.group(1)!=null?Double.parseDouble(matcher.group(1)):0.0;
                double imag = matcher.group(2)!=null?Double.parseDouble(matcher.group(2)):0.0;
                System.out.println("Re{p2} = "+real);
                System.out.println("Im{p2} = "+imag);
                p2 = new Complex64F(real, imag);
            }
            
            matcher = complexPattern.matcher(polo3Field1.getText());
            while (matcher.find()) {
                System.out.println("real encontrado = "+matcher.group(1));
                System.out.println("imaginario encontrado ="+matcher.group(2));
                double real = matcher.group(1)!=null?Double.parseDouble(matcher.group(1)):0.0;
                ...
                System.out.println("Re{p2} = "+real);
                System.out.println("Im{p2} = "+imag);
                p3 = new Complex64F(real, imag);
            }
            
            servo.setPoles(p1, p2, p3);
            
            servo.getK1();
            
            jTableMatrizk1.getModel().setValueAt(servo.getK1(), 0, 0);
            jTableMatrizk2.getModel().setValueAt(servo.getK2()[0], 0, 0);
            jTableMatrizk2.getModel().setValueAt(servo.getK2()[1], 1, 0);
        }else{
          controller.setServoControl(false);
        }
  ...
  private void servoButtonItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_servoButtonItemStateChanged
    if(servoButton.isSelected()){
      ...
      panelPIDControl.setVisible(false);
      try{
      ...
      panelPIDControl.setVisible(true);
  ...
  private javax.swing.JLabel jLabelCochete3;
  private javax.swing.JLabel jLabelCochete4;
  ...
  private javax.swing.JTable jTableMatrizk1;
  private javax.swing.JTable jTableMatrizk2;
  ...
  private javax.swing.JPanel panelPIDControl;
  ...
  private javax.swing.JTextField polo1Field1;
  private javax.swing.JLabel polo1Label;
  private javax.swing.JLabel polo1Label1;
  private javax.swing.JTextField polo2Field;
  private javax.swing.JTextField polo2Field1;
  private javax.swing.JLabel polo2Label;
  private javax.swing.JLabel polo2Label1;
  private javax.swing.JTextField polo3Field1;
  private javax.swing.JLabel polo3Label1;
